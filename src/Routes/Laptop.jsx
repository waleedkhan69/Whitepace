...
import pic1 from '../Image/lap1.jpeg';
import pic2 from '../Image/lap2.jpeg';
import pic3 from '../Image/lap3.jpeg';


const Laptop = () => {
  const mobiledata = [
    { image: pic1, Title: 'Laptop 1', Price: 1120, des: 'This is an tablet, which is more expensive compared to other mobiles.' },
    { image: pic2, Title: 'Laptop 2', Price: 1200, des: 'This is an tablet, which is more expensive compared to other mobiles.' },
    { image: pic3, Title: 'Laptop 3', Price: 9920, des: 'This is an tablet, which is more expensive compared to other mobiles.' }
  ];

  return (
    <Fragment>
      <h1 className="font-bold text-center text-4xl md:text-5xl my-6 md:my-10">Laptop Store</h1>
