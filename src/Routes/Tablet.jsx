...
import pic1 from '../Image/Tab1.jpeg';
import pic2 from '../Image/Tab2.jpeg';
import pic3 from '../Image/Tab3.jpeg';


const Tablet = () => {
  const mobiledata = [
    { image: pic1, Title: 'Tablet 1', Price: 1120, des: 'This is an tablet, which is more expensive compared to other mobiles.' },
    { image: pic2, Title: 'Tablet 2', Price: 1200, des: 'This is an tablet, which is more expensive compared to other mobiles.' },
    { image: pic3, Title: 'Tablet 3', Price: 9920, des: 'This is an tablet, which is more expensive compared to other mobiles.' }
  ];

  return (
    <Fragment>
      <h1 className="font-bold text-center text-4xl md:text-5xl my-6 md:my-10">Tablet Store</h1>
